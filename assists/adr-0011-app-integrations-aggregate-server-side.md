---
title: "ADR 0011 — App-Integrationen server-seitig aggregieren (Solaris als BFF/Hub)"
...
ADR 0009 ([0009-service-tokens-and-trust.md](adr-0009-service-tokens-and-trust.md) — service tokens & trust), `docs/COMPANION_APP.md`; solarisbay #757 (/napi), #2252 (Companion-/napi); solaris-android #40 (ServiceBay-Epic), #47 (Realtime).
