---
title: "ADR 0010 — Node runtime tracks a single LTS line; the minor floats, kept consistent across all four sources"
whenToUse: "You are bumping or pinning Node anywhere — package.json engines, .nvmrc, a CI workflow, the Dockerfile base image — or a native module fails to load with an ABI/version mismatch, and you need to know what must agree and what is deliberately allowed to float."
kind: adr
tags: [adr, decision, node, runtime, ci, docker]
---
...
- **Related:** [ARCHITECTURE_INVARIANTS.md](../docs/ARCHITECTURE_INVARIANTS.md), #2166, #2329
