---
title: "ADR 0003 — Versioning and releases go through release-please only; commit subjects stay parser-clean"
whenToUse: "You are about to touch a version number, a CHANGELOG, the release manifest or a commit subject — or a release was not cut, a commit did not show up in the changelog, and you want to know whether a change may ship as its own release."
kind: adr
tags: [adr, decision, release, versioning, commits]
---
...
- **Related:** [ADR 0004](adr-0004-installs-are-non-destructive.md), CONTRIBUTING.md
