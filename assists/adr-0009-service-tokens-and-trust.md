...
- **Related ADRs:** [0001](adr-0001-authentication-via-authelia-sso-or-lldap.md) (the operator→service auth decision; §2 here is the credential/trust elaboration), [0002](adr-0002-tiered-backup-nas-config-vs-bulk-drive.md), [0006](adr-0006-authelia-apex-deny-vs-wildcard.md)

> Format: Status / Context / Decision / Consequences, in the
> spirit of [`UX_DECISIONS.md`](../docs/UX_DECISIONS.md) — record the choices that are
