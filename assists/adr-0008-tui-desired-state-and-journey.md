---
title: "ADR 0008 — The TUI is a desired-state stack editor and a numbered setup-journey map"
whenToUse: "You are changing the sb-tui — the stack panel, an install/uninstall keystroke, the setup menu order — and need to know why an already-installed stack is never silently redeployed, why core stacks cannot be unchecked, and why the journey starts with staging backups."
kind: adr
tags: [adr, decision, tui, install, ux]
---
...
- **Related:** [ADR 0004](adr-0004-installs-are-non-destructive.md), UX_PHILOSOPHY.md
...
unchecked** — the backend hard-refuses (Factory-Reset-only, [ADR 0004](adr-0004-installs-are-non-destructive.md)),
