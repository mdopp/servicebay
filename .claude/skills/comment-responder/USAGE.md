...
- `/comment-responder sweep` — walk all open issues/PRs + the autoloop `autoloop:awaiting-user` label.
...
the `autoloop:awaiting-user` label and never replies itself — this skill is where those get answered.
