# ADR 0001 — moved to the assist catalog
...
- **Assist id:** `adr-0001-authentication-via-authelia-sso-or-lldap`
- **File:** [`assists/adr-0001-authentication-via-authelia-sso-or-lldap.md`](../../assists/adr-0001-authentication-via-authelia-sso-or-lldap.md)
- **Over MCP:** `get_assist("adr-0001-authentication-via-authelia-sso-or-lldap")`, or find it with `list_assists` — its
