# ADR 0007 — moved to the assist catalog
...
- **Assist id:** `adr-0007-container-network-isolation-and-carveouts`
- **File:** [`assists/adr-0007-container-network-isolation-and-carveouts.md`](../../assists/adr-0007-container-network-isolation-and-carveouts.md)
- **Over MCP:** `get_assist("adr-0007-container-network-isolation-and-carveouts")`, or find it with `list_assists` — its
