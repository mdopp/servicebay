...
| 0010 | [`adr-0010-node-lts-line-minor-floats`](../../assists/adr-0010-node-lts-line-minor-floats.md) | Node runtime tracks one LTS line (now Node 22; amended from Node 20, #2329); the minor floats, kept consistent across package.json / .nvmrc / CI / Dockerfile |
