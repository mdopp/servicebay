...
| [0010](0010-node-20-minor-floats.md) | Node runtime tracks one LTS line (now Node 22; amended from Node 20, #2329); the minor floats, kept consistent across package.json / .nvmrc / CI / Dockerfile |
