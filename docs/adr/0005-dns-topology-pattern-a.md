# ADR 0005 — moved to the assist catalog
...
- **Assist id:** `adr-0005-dns-topology-pattern-a`
- **File:** [`assists/adr-0005-dns-topology-pattern-a.md`](../../assists/adr-0005-dns-topology-pattern-a.md)
- **Over MCP:** `get_assist("adr-0005-dns-topology-pattern-a")`, or find it with `list_assists` — its
